...
Weapon::Weapon(vector2* playerPos, vector2 offset, vector2 shootOffsetPos, int shootSpeed, int damage, TextureType weaponTType, TextureType projtTType, CollideBoxType projtCBType){
