...
enum TextureType{
    ...
    TEX_sprite_mapBrick_level1,
    TEX_sprite_mapBrick_level2,
    TEX_sprite_mapBrick_level3,
    TEX_sprite_map_level1,
    TEX_sprite_map_level2,
    TEX_sprite_map_level3,
    TEX_sprite_background_level1,
    TEX_sprite_background_level2,
    TEX_sprite_background_level3,
    TEX_weapon_pistol,
    TEX_weapon_revolver,
    TEX_weapon_dualgun,
    TEX_weapon_disc,
